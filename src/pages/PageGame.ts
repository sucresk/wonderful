class PageGame extends State
{
    ...
    private _timeBarBg:egret.Bitmap;
    private _timeBar:egret.Bitmap;
    private _timeMask:egret.Shape;
    ...
    public constructor()
    {
        ...
        this.hitSound = RES.getRes("yinxiao_wav");
        this.bgSound = RES.getRes("yinyue_mp3");
    }
    ...
    public init()
    {
        ...
        this.bgChannel = this.bgSound.play(0,1000);
        super.init();
    ...
    private initRoleBg():void
    {
        ...
        for(var i:number = this._roleQueue.length - 1; i >= 1; i--)
        {
            ...
            rolebg.x = this.stage.stageWidth / 2 + (i * 40);
            rolebg.y = this.stage.stageHeight - 200 - (i * 50) - rolebg.height / 2;
            rolebg.scaleX = rolebg.scaleY = 1 -  (i)* 0.05;
    ...
    private initUI():void
    {
        ...
        this._btn0.x = this.stage.stageWidth/ 2 - 150;
        ...
        this._btn1.x = this.stage.stageWidth/ 2 - 150;
        ...
        this._btn2.x = this.stage.stageWidth/ 2 + 150;
        ...
        this._btn3.x = this.stage.stageWidth/ 2 + 150;
        this._btn3.y = this.stage.stageHeight  - 100;
        this._uiContainer.addChild(this._btn3);
        this._btn3.visible = false;

        this._bossBtn = new Hand();
        this._bossBtn.x = this.stage.stageWidth / 2 - 20;
        this._bossBtn.y = this.stage.stageHeight - 150;
        this._uiContainer.addChild(this._bossBtn);
        ...
        this._txtHit.size = 40;
        this._txtHit.x = 10;
        this._txtHit.y = 50;
        this._uiContainer.addChild(this._txtHit);

        this._timeBar = this.createBitmapByName("line_png");
        this._timeBarBg = this.createBitmapByName("line_bg_png");
        this._timeBar.x = this._timeBar.width / 2 + 10;
        this._timeBar.y = 20;
        this._timeBarBg.x = this._timeBar.width / 2 + 10;
        this._timeBarBg.y = 20;
        this._uiContainer.addChild(this._timeBarBg);
        this._uiContainer.addChild(this._timeBar);
        this._timeMask = new egret.Shape();
        this._timeMask.graphics.beginFill(0xff0000);
        this._timeMask.graphics.drawRect(0,0,this._timeBar.width, this._timeBar.height);
        this._timeMask.x = 10;
        this._timeMask.y = 10;
        //this._uiContainer.addChild(this._timeMask);
    ...
    private refreshUI():void
    {
        ...
        this._txtHit.text = "点击数: " + this._curHit.toString();
        var p:number = this._curTime / PageGame.TOTAL_TIME;
        //this._timeMask.x = 10 - (1-p) * this._timeMask.width;
        this._timeBar.scaleX = p;
    ...
    private endGame():void
    {
        ...
        ScoreManager.curScore = this.curLevel;
        if(this.curLevel > ScoreManager.maxScore)
        {
            ScoreManager.maxScore = this.curLevel;
        }
        ScoreManager.curHit = this._curHit;
        if(this._curHit > ScoreManager.maxHit)
        {
            ScoreManager.maxHit = this._curHit;
        }
        this.over();
    }
